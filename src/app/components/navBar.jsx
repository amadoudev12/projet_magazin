        ...
        <div className="flex justify-between items-center max-w-7xl mx-auto">
            ...
            {isAuthenticated && (
                ...
                <li>
                    <button
                    onClick={() => signOut()}
                    className="px-4 py-2 rounded-full bg-gradient-to-r from-orange-500 to-red-600 text-white font-medium shadow hover:shadow-lg hover:scale-105 transition-transform"
                    >
                    Déconnexion
                    </button>
                </li>
                {admin && (
                    ...
                    <Link
                        href="/admin"
                        className="px-4 py-2 rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-medium shadow hover:shadow-lg hover:scale-105 transition-transform"
                    >
                        Tableau de bord
                    </Link>
                    </li>
        ...
        {menuOpen && (
            ...
            {isAuthenticated && (
                ...
                <li>
                    ...
                    className="w-full px-5 py-2 rounded-full bg-gradient-to-r from-orange-500 to-red-600 text-white font-medium shadow-md hover:shadow-lg hover:scale-105 transform transition-all duration-300"
                    >
                    Déconnexion
                    </button>
                </li>
                {admin && (
                    ...
                    <Link
                        href="/admin"
                        onClick={() => setMenuOpen(false)}
                        className="w-full px-5 py-2 rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-medium shadow-md hover:shadow-lg hover:scale-105 transform transition-all duration-300"
                    >
                        Tableau de bord
                    </Link>
                    </li>
